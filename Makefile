# LoukoumasCPC - build with rasm (https://github.com/EdouardBERGE/rasm)
#
#   make              everything
#   make loukoumas    the game, English and Greek: snapshots and disc images
...
.PHONY: all loukoumas assets shots covers manuals check clean
